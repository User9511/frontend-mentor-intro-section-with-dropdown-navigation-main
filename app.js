...
function toggleAriaExpanded() {
  let x = document.getElementById("menu-icon").getAttribute("aria-expanded");
  let y = document.getElementById("menu-icon-close").getAttribute("aria-expanded");
  ...
  document.getElementById("menu-icon").setAttribute("aria-expanded", x);
}
